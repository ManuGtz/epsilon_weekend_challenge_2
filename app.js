$(document).ready(function() {
	...
	$('.imdbbutton').on('click', function(){
		...
		$(".imdbinfo").append("<img class = 'imdbhtml pics' src= 'http://ia.media-imdb.com/images/M/MV5BMjAyNTcxNzYwMV5BMl5BanBnXkFtZTgwMzQzNzM5MjE@._V1_SX300.jpg'>");
	});
	...
	$('.imdbbutton2').on('click', function(){
			$('.imdbhtml').remove();	
			$(".imdbinfo").append("<p class='imdbhtml'> " + data.Plot + "</p>" + "<p class='imdbhtml'>" + 'IMDB Rating: ' + data.imdbRating +"</p>");
			$(".imdbinfo").append("<img class='imdbhtml pics' src= 'http://ia.media-imdb.com/images/M/MV5BMjI5NTA4NzI1OF5BMl5BanBnXkFtZTgwNzczMDY5MDE@._V1_SX300.jpg'>");
	});
